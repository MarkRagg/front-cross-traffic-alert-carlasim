...
class World(object):
    ...
    def toggle_radar(self):
        if self.radar_sensor is None:
            ...
            self.radar_right = RadarSensor(self.player, "right", y=1, pitch=5, yaw=50)   # Attach right radar to 'vehicle'
            self.radar_left = RadarSensor(self.player, "left", y=-1, pitch=5, yaw=-50)  # Attach left radar to 'vehicle'
...
# -- game_loop() ---------------------------------------------------------------
# ==============================================================================
def spawn_vehicle(world, vehicle_index=0, spawn_index=0, x_offset=0, y_offset=0, pattern='vehicle.*model3*') -> carla.Vehicle:
...
def game_loop(args):
    ...
    try:
        ...
        for i in range (0, 5):
            target_vehicle = spawn_vehicle(spawn_index=i, world=sim_world)
