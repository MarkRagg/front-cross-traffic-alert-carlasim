...
left_vehicle = spawn_vehicle(x_offset=175, y_offset=20, rotation=Rotation(yaw=270, pitch=0, roll=0))
right_vehicle = spawn_vehicle(x_offset=170, y_offset=-80, rotation=Rotation(yaw=90, pitch=0, roll=0))
